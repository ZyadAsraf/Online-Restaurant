    ...
    <div class="wrapper">
        ...
        if (isset($_GET['ID'])) {
            ...
            if ($result == true) {
                ...
                echo "<div style='color: red;'>Failed to fetch staff details</div>";
            }
        } else {
            header("location:" . HOMEURL . 'admin/Manage-kitchen.php');
            exit;
...
if (isset($_POST['submit'])) {
    ...
    if ($result == true) {
        $_SESSION['update'] = "<div style='color: green;'><strong>Staff Updated Successfully</strong></div>";
        header("location:" . HOMEURL . 'admin/Manage-kitchen.php');
        exit;
    } else {
        $_SESSION['update'] = "<div style='color: red;'>Failed to Update Staff</div>";
        header("location:" . HOMEURL . 'admin/Manage-kitchen.php');
        exit;
    }
}
