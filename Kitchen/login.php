...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM kitchen WHERE Email = '$email' AND Password = '$password'";
    ...
    if ($count == 1) {
        ...
        $_SESSION['role'] = "kitchen"; // Set the user role

        header("location:".HOMEURL.'kitchen/index.php');
    } else {
        $_SESSION['login'] = "<div style='color: red;'><h3><strong>E-mail or Password is incorrect!</strong></h3></div>";
        header("location:".HOMEURL.'kitchen/login.php');
    }
}
